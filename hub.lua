...
_G.Fruits_Settings = { -- ตั้งค่าผล
    ['Main_Fruits'] = {'Light-Light'}, -- ผลหลัก ถ้ายังไม่ใช่ค่าที่ตั้งมันจะกินจนกว่าจะใช่หรือซื้อ
...
getgenv().Key = "MARU-XRKH0-534CH-FDOV-ZUP2O-Y28G"
getgenv().id = "274545748174176256"
